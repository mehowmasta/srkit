...
public enum DefenseModifier{
	...
	DefReach("Defender has longer reach","+1 per net Reach",true,"NetReach",10,1),
	DefWound("Defender wounded","-[Wound]",true,"Wound",-1,-10),
	DefPrevAtk("Defender has defended against previous attack","-1 per previous attack",true,"PrevAtk",-1,-30),
	...
	AtkReach("Attacker has longer reach","-1 per net Reach",true,"NetReach",-1,-10),
